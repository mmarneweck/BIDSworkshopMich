...
path_toplevel = os.path.join(os.sep, "projects", "motorskill", "shared", "BIDSworkshopMich") # folder that contains path_bidsdata and path_conversionfolder
...
path_bidsdata = os.path.join(os.sep, "projects", group, "shared", "BIDSworkshopMich", "bids_data") # Where the niftis will be put
